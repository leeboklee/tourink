...
export const RESOURCE_FIELDS: Record<AdminResourceKey, FieldDef[]> = {
  experiences: [
    ...
    { key: "imageLicense", label: "Image license", type: "select", options: ["unsplash", "pexels", "cc0", "dicebear-cc0", "owned"], hint: "Required — see CONTENT_LICENSE.md" },
    { key: "imageAttribution", label: "Image attribution", type: "text", hint: "e.g. Photo by Name on Unsplash" },
  ...
  profiles: [
    ...
    { key: "name", label: "Display name", type: "text", hint: "Guide Mina · Seoul" },
    { key: "bio", label: "Bio", type: "textarea" },
    { key: "city", label: "City", type: "text" },
    { key: "image", label: "Avatar URL", type: "text", hint: "Prefer DiceBear CC0 for Official AI guides" },
    { key: "imageLicense", label: "Avatar license", type: "select", options: ["unsplash", "pexels", "cc0", "dicebear-cc0", "owned"], hint: "Required — ban scraped faces" },
    { key: "imageAttribution", label: "Avatar attribution", type: "text", hint: "e.g. DiceBear bottts-neutral · CC0 1.0" },
